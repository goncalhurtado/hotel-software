...
import { createRoom } from "../../../helpers/admin/rooms";

const CreateRoomForm = ({ getRooms, modal }) => {
  const categories = modal.data;
  ...
  const handleSubmit = async (e, formData, setLoading) => {
    await createRoom(e, formData, setLoading, setError, getRooms);
  };
